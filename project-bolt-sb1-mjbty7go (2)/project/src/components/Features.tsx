...
const features = [
  {
    ...
    description: 'Support for popular programming languages including JavaScript, Python, and CSS.'
  },
  {
  ...
  },
  {
    ...
    title: 'AI-Powered',
    description: 'Powered by OpenAI to provide accurate and up-to-date programming knowledge.'
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our AI-powered assistant provides comprehensive learning resources to help you master programming concepts quickly and effectively.
          </p>
        </div>
